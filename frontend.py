...
user_query=st.text_area("Enter your query: ", height=150, placeholder="Ask a question...")
    ...
    if user_query.strip():
        ...
        if response.status_code == 200:
            ...
            if "error" in response_data:
                ...
                st.subheader("Here's the Agent Response")
                st.markdown(f"**Response:** \n{response_data.get('response', 'No response from agent.')}")